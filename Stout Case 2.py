...
year = ['2015-2016','2016-2017']
base_cus = [231294,204646]
cus_accuired = [145062,229028]
cus_lost = [-171710,-183687]


# In[144]:


df = pd.DataFrame({'year':year,                   "customer_previous_year":base_cus,                   'customer_accquired':cus_accuired,
...
fig = px.bar(df, x="year", y = ["customer_previous_year","customer_accquired","customer_lost"],
...
df2 = pd.DataFrame({'year':year,"base_revenue":base_revenue,                   "existing_customer_revenue":existing_customer,                   'new_customer_revenue':new_customer_revenue})


# In[131]:


fig = px.bar(df2, x="year", y=["base_revenue", "existing_customer_revenue",'new_customer_revenue'],
